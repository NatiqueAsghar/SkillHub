...
const Discover = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen text-txt">
      {/* <div className="w-full hidden md:hidden bg-primary border-r border-line p-6 sticky top-0 ">
        <nav className="flex flex-col gap-4">
          <a href="#for-you" className="text-txt hover:bg-text-secondary">
            For You
          </a>
          <a href="#popular" className="text-txt hover:text-secondary">
            Popular
          </a>
          <a href="#web-development" className="text-txt hover:text-secondary">
            Web Development
          </a>
          <a href="#machine-learning" className="text-txt hover:text-secondary">
            Machine Learning
          </a>
          <a href="#others" className="text-txt hover:text-secondary">
            Others
          </a>
        </nav>
      </div> */}
      ...
      <div className="w-full  p-6">
        {loading ? (
          ...
          <>
            <h1
              id="for-you"
              className="text-3xl font-bold text-tl mb-6 font-josefin"
            >
              For You
            </h1>
            <div className="flex justify-center flex-wrap gap-4 border-b border-line">
