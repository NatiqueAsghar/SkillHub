  ...
  return (
    <div className="flex flex-col items-center relative overflow-hidden">
      <div className="flex  items-center min-h-[92vh]">
        <h2 className="text-center text-tl font-oswald w-full text-[6rem] font-bold">
          SKILL HUB
        </h2>
      </div>

      <h2 className="text-center text-tl font-oswald bg-bgd w-full text-[3rem] font-bold  border-b border-t border-line">
        WHY SKILL HUB?
      </h2>

      <div className="text-center items-center min-h-[92vh] mb-10 mt-10">
        <div className="font-montserrat text-txt text-[1.2rem] max-w-[1000px] mx-auto p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-left">
            <div>
              <h4 className="text-tl border-b border-line font-semibold mb-2">
                Learn From Experts
              </h4>
              <p>
