...
const Register = () => {
  ...
  return (
    <div className="min-h-screen p-4">
      <h1 className="text-3xl font-bold text-center text-tl mb-8">
        Registration Form
      </h1>
      ...
      {loading ? (
        ...
        <div className="max-w-4xl mx-auto border border-bgd rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 border border-line rounded bg-gray-800 text-txt placeholder-gray-400 disabled:bg-gray-700 disabled:text-gray-500 focus:outline-none focus:ring-1 focus:ring-tl"
                  value={form.name}
                  disabled
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  value={form.username}
                  className="w-full p-2 border border-line rounded bg-gray-800 text-txt placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-tl"
              ...
              <div>
                ...
                {form.skillsProficientAt.length > 0 && (
                  <div className="flex flex-wrap gap-2 mt-2">
                    {form.skillsProficientAt.map((skill, index) => (
                      <span
                        key={index}
                        className="bg-line text-txt px-3 py-1 rounded-full text-sm flex items-center border border-bgd shadow-sm cursor-pointer hover:bg-tl"
                        onClick={(event) =>
                ...
                <button
                  className="mt-2 px-4 py-2 border border-line text-txt rounded hover:bg-tl"
              ...
              <div className="flex justify-center space-x-4 mt-6">
                <button
                  className="px-4 py-2 border border-line text-txt rounded hover:bg-tl disabled:opacity-50"
                ...
                >
                  {saveLoading ? (
                    <span className="flex items-center">
                      <svg
                        className="animate-spin -ml-1 mr-2 h-4 w-4 text-txt"
                ...
                <button
                  onClick={handleNext}
                  className="px-4 py-2 border border-line text-txt rounded hover:bg-tl"
                >
                  Next
                </button>
              </div>
          ...
          {activeKey === "education" && (
            <div className="space-y-4">
                ...
                >
                  {index !== 0 && (
                    <div className="flex justify-end">
                      <button
                        className="text-rd hover:text-red-700"
              ...
              <div className="flex justify-center space-x-4 mt-6">
                <button
                  className="px-4 py-2 bg-yellow-500 text-txt rounded hover:bg-yellow-600 disabled:opacity-50"
...
//Confirm Details
          {activeKey === "longer-tab" && (
            <div className="space-y-4">
              <div>
                <label className="block text-teal-500 mb-1">
                ...
                <textarea
                  ...
                  value={form.bio}
                  onChange={handleInputChange}
                  className="w-full p-2 border border-teal-500 rounded bg-white text-black placeholder-gray-500 disabled:bg-gray-100 disabled:text-gray-500 focus:outline-none focus:ring-1 focus:ring-teal-500"
              ...
              <div>
                <label className="block text-teal-500 mb-1">Projects</label>
                ...
                {form.projects.map((project, index) => (
                  ...
                  >
                    ...
                    <div>
                      <label className="block text-teal-500 mb-1">Title</label>
                      <input
                        type="text"
                        name="title"
                        value={project.title}
                        onChange={(e) => handleAdditionalChange(e, index)}
                        className="w-full p-2 border border-teal-500 rounded focus:outline-none focus:ring-1 focus:ring-teal-500"
                      ...
                      {techStack[index].length > 0 && (
                        <div className="flex flex-wrap gap-2 mt-2">
                          {form.projects[index].techStack.map((skill, i) => (
                            <span
                              key={i}
                              className="bg-gray-200 text-gray-800 px-3 py-1 rounded-full text-sm flex items-center cursor-pointer hover:bg-gray-300"
                              onClick={(e) => {
                                setForm((prevState) => ({
                                  ...prevState,
                                  projects: prevState.projects.map((item, i) =>
          ...
          {activeKey === "Preview" && (
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-center text-teal-500">
                Preview of the Form
              </h3>
              <div className="space-y-4">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                  <span className="font-bold text-teal-500 w-full md:w-1/4">
                    Name:
                  </span>
                  <span className="bg-gray-200 text-gray-800 w-full md:w-3/4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                  ...
                  <span className="bg-gray-200 text-gray-800 w-full md:w-3/4 break-words">
